        ...
        <div className="md:col-span-2 space-y-4">
            ...
            {!isScanning && (
              <div className="text-center p-6 space-y-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-white font-medium text-xs transition-colors disabled:opacity-50 cursor-pointer"
                >
          ...
          <div className="flex flex-wrap items-center gap-3 p-4 rounded-xl bg-white border border-slate-200 shadow-sm text-slate-900">
            {isScanning ? (
              <button
                onClick={stopScanner}
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-500 hover:bg-red-600 text-white font-medium text-xs transition-colors cursor-pointer"
              >
